...
Current focus: `Step 14 is verified. The optional provider wrapper now exists in code/llm.py as a bounded, fail-closed layer, and the next unfinished work is Step 15.`

Current recommended next action: `Start Step 15 by deciding the narrowest safe place to call the optional wrapper for bounded synthesis while keeping deterministic routing, safety, and taxonomy in control.`
